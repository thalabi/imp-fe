...
import { InstrumentBond } from '../bond/InstrumentBond';
...
@Component({
    selector: 'app-interest-bearing',
    templateUrl: './interest-bearing.component.html',
    styleUrls: ['./interest-bearing.component.css']
})
export class InterestBearingComponent extends InstrumentMaintenanceComponent implements OnInit {
